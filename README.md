...
- **中文文档索引**：参见 `docs/README.md`
- **English Documentation Index**：see `docs/READMEEN.md`
- **部署与运维**：参见 `docs/DEPLOYMENT.md`
- **多节点数据同步方案**：参见 `docs/SYNC.md`
- **愿景与设计方向（英文）**：参见 `docs/VISION.md`
...
| 建议者 | 建议者 | 测试贡献者 |
| --- | --- | --- |
| <img src="docs/images/contributor/suggestion/仲秀.png" width="100" alt="仲秀"> | <img src="docs/images/contributor/suggestion/杨光.png" width="100" alt="杨光"> | <img src="docs/images/contributor/suggestion/懂普帝.jpg" width="100" alt="懂普帝"> |
| **仲秀** | **杨光** | ** 懂普帝 ** |
