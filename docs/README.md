...
- **[代码优化说明](OPTIMIZATION.md)** - 代码架构和优化说明
  - 优化目标
  - Service 层设计
  - Trait 使用
  - Controller 重构
...
- **[发布新版本指南](RELEASE.md)** - 如何在 GitHub 和 Gitee 上发布新版本
  - 发布前准备
  - 创建 Git Tag
  - GitHub/Gitee 发布步骤
  - 版本号规范
...
2. 阅读 [部署指南](DEPLOYMENT.md) 了解如何部署项目
3. 阅读 [多节点数据同步](SYNC.md) 了解核心功能
4. 查看 [流量统计功能](traffic-statistics.md) 了解统计功能

### 开发者
1. 阅读 [代码优化说明](OPTIMIZATION.md) 了解代码架构
2. 查看 [多节点数据同步](SYNC.md) 了解同步机制
3. 参考 [发布新版本指南](RELEASE.md) 进行版本发布
