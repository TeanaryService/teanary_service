...
// Pour maintenir la structure "un module par fichier, structure de répertoires cohérente avec Livewire"
// et en même temps pouvoir utiliser la syntaxe de point __('manager.xxx.yyy'),
// les sous-répertoires manager/*.php sont inclus ici dans un manager.php unifié.

return [
    'dashboard' => require __DIR__.'/manager/dashboard.php',

    // Statistiques commerciales / Trafic
    ...
    // Catégories et attributs et spécifications
