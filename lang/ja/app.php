...
return [
    ...
    'avatar_upload_hint' => 'JPG、PNG、GIF形式をサポート、最大2MB',
    'email_cannot_change' => 'メールアドレスは変更できません',
    'password_leave_blank' => 'パスワードを変更しない場合は空のままにしてください',
    'email_verify_subject' => 'メールアドレスを確認してください',
    'email_verify_line1' => '以下のボタンをクリックしてメールアドレスを確認してください。',
    'email_verify_action' => 'メールを確認',
    'email_verify_line2' => 'アカウントを作成していない場合は、このメールを無視してください。',
    'images' => '画像',
