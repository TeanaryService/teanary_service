...
return [
    ...
    'alpha_dash' => 'Поле :attribute может содержать только буквы, цифры, дефисы и знаки подчеркивания.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Данный :attribute был обнаружен в утечках данных. Пожалуйста, выберите другой :attribute.',
    ],
    ...
    'required_without_all' => 'Поле :attribute обязательно, когда ни одного из :values нет.',
