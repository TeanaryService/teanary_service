...
@php
    $selectId = $id ?? $name;
    // 统一输入框样式
    $baseClasses = 'w-full px-4 py-3 rounded-xl border-2 border-teal-100 bg-white text-gray-900 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-500 hover:border-teal-200 hover:shadow-md cursor-pointer';
