...
@if($type === 'tea-garden')
    ...
    <div class="absolute inset-0 {{ $intensityClass }} pointer-events-none">
        <div class="absolute top-10 left-10 w-32 h-32 0 rounded-full blur-3xl"></div>
        ...
        <div class="absolute top-1/4 right-1/3 w-20 h-20 bg-teal-400 rounded-full blur-2xl"></div>
        <div class="absolute bottom-1/4 left-1/2 w-12 h-12 bg-bamboo-400 rounded-full blur-xl"></div>
    </div>
@elseif($type === 'mountain-tea')
    {{-- 山茶背景 --}}
    <div class="absolute inset-0 {{ $intensityClass }} pointer-events-none">
        <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-teal-100/20 via-transparent to-bamboo-100/20"></div>
        <div class="absolute top-20 left-20 w-40 h-40 bg-teal-300 rounded-full blur-3xl"></div>
...
@elseif($type === 'ceremony')
    {{-- 茶道背景 --}}
    <div class="absolute inset-0 {{ $intensityClass }} pointer-events-none">
        <div class="absolute inset-0 bg-gradient-to-tr from-teal-50/30 via-transparent to-ceramic-50/30"></div>
        <div class="absolute top-1/4 left-1/4 w-28 h-28 bg-teal-400 rounded-full blur-2xl"></div>
