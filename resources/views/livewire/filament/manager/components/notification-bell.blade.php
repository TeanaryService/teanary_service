<div class="relative">
    <a href="{{ \App\Filament\Manager\Pages\Notifications::getUrl() }}" 
       class="relative inline-flex items-center justify-center w-10 h-10 text-gray-600 hover:text-teal-600 transition-colors">
