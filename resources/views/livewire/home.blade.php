<div class="bg-gray-50">
    ...
    <section class="w-full bg-teal-200 bg-gradient-to-br from-teal-200 via-gray-50 to-tea-50/30 py-20 md:py-28 relative overflow-hidden">
        ...
        <div class="w-full max-w-screen 2xl:max-w-[75vw] mx-auto px-6 md:px-8 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-16 relative z-10">
    ...
    <section class="py-20 md:py-24 bg-white relative">
        <div class="w-full max-w-screen 2xl:max-w-[75vw] mx-auto px-6 md:px-8 flex flex-col md:flex-row items-center gap-12 md:gap-16">
            <div class="md:w-1/2">
                <div class="tea-decoration mb-8">
