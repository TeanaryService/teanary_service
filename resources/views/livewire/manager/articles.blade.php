        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="flex-1">
                <div class="mb-6 flex items-center justify-between">
                    <h1 class="text-3xl font-bold text-gray-900">{{ __('manager.articles.label') }}</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="1">{{ __('manager.article.published') }}</option>
                                <option value="0">{{ __('manager.article.unpublished') }}</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
...
@pushOnce('seo')
    <x-layouts.seo title="{{ __('manager.articles.label') }}" description="{{ __('manager.articles.label') }}"
        keywords="{{ __('manager.articles.label') }}" />
@endPushOnce
