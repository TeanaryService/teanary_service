            ...
            <div class="flex-1">
                ...
                @if($this->hasSelectedItems())
                    <x-manager.batch-actions 
                        ...
                        deleteMethod="batchDeleteArticles"
                        translationStatusMethod="batchSetArticleTranslationStatus"
                                ...
                                @forelse($articles as $article)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <x-widgets.checkbox 
                                                standalone
                                                wireClick="toggleSelect({{ $article->id }})"
                                                :checked="in_array($article->id, $selectedItems)"
                                            />
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
