                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach($attributes as $attribute)
                                    <option value="{{ $attribute->id }}">{{ $this->getAttributeName($attribute, $lang) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end gap-2">
                                                <a href="{{ locaRoute('manager.attribute-values.edit', ['id' => $attributeValue->id]) }}" 
...
@pushOnce('seo')
    <x-layouts.seo title="{{ __('manager.attribute_values.label') }}" description="{{ __('manager.attribute_values.label') }}"
