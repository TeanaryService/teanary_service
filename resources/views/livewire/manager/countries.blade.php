            ...
            <div class="flex-1">
                ...
                @if($this->hasSelectedItems())
                    <x-manager.batch-actions 
                        ...
                        deleteMethod="batchDeleteCountries"
                        translationStatusMethod="batchSetCountryTranslationStatus"
                        activeStatusMethod="batchSetCountryActiveStatus"
                    />
                @endif
                                ...
                                @forelse($countries as $country)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <x-widgets.checkbox 
                                                standalone
                                                wireClick="toggleSelect({{ $country->id }})"
                                                :checked="in_array($country->id, $selectedItems)"
                                            />
                                        </td>
