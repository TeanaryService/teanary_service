...
@pushOnce('seo')
    <x-layouts.seo title="{{ $isEdit ? __('app.edit') : __('app.create') }} {{ __('manager.countries.label') }}" description="{{ $isEdit ? __('app.edit') : __('app.create') }} {{ __('manager.countries.label') }}"
        keywords="{{ __('manager.countries.label') }}" />
@endPushOnce
