    ...
    <div class="w-full max-w-screen 2xl:max-w-[80vw] mx-auto px-6 md:px-8">
        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="flex-1">
                ...
                >
                    <x-slot:actions>
                        <x-widgets.button href="{{ locaRoute('manager.specification-values.create') }}" wire:navigate class="inline-flex items-center gap-2">
                ...
                @if($this->hasSelectedItems())
                    <x-manager.batch-actions 
                        ...
                        deleteMethod="batchDeleteSpecificationValues"
                        translationStatusMethod="batchSetSpecificationValueTranslationStatus"
                    />
                @endif
                                ...
                                @forelse($specificationValues as $value)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <x-widgets.checkbox 
                                                standalone
                                                wireClick="toggleSelect({{ $value->id }})"
                                                :checked="in_array($value->id, $selectedItems)"
                                            />
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end gap-2">
                                                <a href="{{ locaRoute('manager.specification-values.edit', ['id' => $value->id]) }}" wire:navigate 
...
<x-seo-meta title="{{ __('manager.specification_values.label') }}" />