@php
    $breadcrumbs = buildManagerCenterBreadcrumbs('specification-values', __('filament.SpecificationValueResource.label'));
@endphp
        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="flex-1">
                <div class="mb-6 flex items-center justify-between">
                    <h1 class="text-3xl font-bold text-gray-900">{{ __('filament.SpecificationValueResource.label') }}</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input 
                                ...
                                placeholder="{{ __('filament.specification_value.name') }}"
                            ...
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        {{ __('filament.specification_value.name') }}
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        {{ __('filament.specification_value.specification') }}
                                    </th>
