        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="flex-1">
                <div class="mb-6 flex items-center justify-between">
                    <h1 class="text-3xl font-bold text-gray-900">{{ __('manager.zones.label') }}</h1>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            >
                                <option value="">{{ __('app.all') }}</option>
                                <option value="1">{{ __('manager.zone.active') }}</option>
                                <option value="0">{{ __('manager.zone.inactive') }}</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
...
@pushOnce('seo')
    <x-layouts.seo title="{{ __('manager.zones.label') }}" description="{{ __('manager.zones.label') }}"
        keywords="{{ __('manager.zones.label') }}" />
@endPushOnce
