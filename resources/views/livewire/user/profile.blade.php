<div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row gap-12 py-10">
    ...
    <div class="w-full md:w-3/4">
        ...
        <form wire:submit.prevent="updateProfile" class="space-y-6 bg-white p-6 rounded-xl shadow-md">
            ...
            <div>
                <label
                    class="block mb-1 text-sm font-medium text-gray-700">{{ __('auth.email') }}（{{ __('app.readonly') }}）</label>
            ...
            <div>
                <label
                    class="block mb-1 text-sm font-medium text-gray-700">{{ __('auth.confirm_new_password') }}</label>
